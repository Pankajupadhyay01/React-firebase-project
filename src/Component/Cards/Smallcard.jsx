...
const Smallcard = () => {
    return (
        <>
            <div className='w-[90%]  flex justify-center flex-wrap gap-4'>
                {
                    Herodata.map((pro, i) => (

                        <div key={i} className='flex flex-col justify-center items-center w-[calc(50%-10px)] bg-slate-100 p-[10px_10px] rounded-lg gap-2'>
